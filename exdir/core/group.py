...
class Group(Object):
    ...
    def require_group(self, name):
        """
        Open an existing group or create it if it does not exist.

        Parameters
        ----------
        name: str
            Name of the group. Must follow the naming convention of the parent Exdir File.
    ...
    def keys(self):
        """
        Names of all the objects in the group.
        """
        return abc.KeysView(self)

    def items(self):
        """
        Names and values of all the objects in the group.
        """
